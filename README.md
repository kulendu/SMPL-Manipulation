This is a Python tutorial on using basic functions for manipulating [SMPL](https://smpl.is.tue.mpg.de/) and visualizing it using [Polyscope](https://polyscope.run/py/) and [Trimesh](https://trimesh.org/) libraries. 
